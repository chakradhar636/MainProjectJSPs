    ...
    <div id="templatemo_menu">
        <div class="indentmenu">
            <ul>
                ...
                <li><a href="DisplayVehicles.jsp?page=1" rel="tab4">DisplayVehicles</a></li>
                <li><a href="Service.jsp" rel="tab5">Service</a></li>
                <li><a href="DisplayService.jsp?page=1" rel="tab6">DisplayService</a></li>
    ...
    <div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left">
                <center>
                    <%
                        out.println("Welcome To Vehicle Management System");
                    %>
                </center>
            </div>
