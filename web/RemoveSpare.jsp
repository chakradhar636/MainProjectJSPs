    ...
    <div id="templatemo_menu">
        <div class="indentmenu">
            <ul>
                ...
                <li><a href="RemoveSpare.jsp" rel="tab3" class="selected">Remove SparePart</a></li>
    ...
    <div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left">
                <center>
                    <form action ="CheckRemoveSpare.jsp" method="post" onsubmit="return Checked();" style="margin-left: 150px;float: left">
                        <p><h4>Remove Spare Parts </h4></p>
                        <p style="font-family: fantasy">Enter Spare Part ID to remove</p>
                        <p><input type="text" onpaste="return false;" name="sid" id="sid" style="height:25px;width:220px;"/></p>

                        <p ><input type="submit" value="Remove" style="height:25px;width:100px;font-family: cursive" /> <input type="reset" value="Cancel" style="height:25px;width:100px;font-family: cursive" /></p>
                    </form>
                </center>
            </div>
