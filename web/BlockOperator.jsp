    ...
    <div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left">
                <center>
                    <form action ="CheckBO.jsp" method="post" onsubmit="return Checked();" style="margin-left: 150px;float: left">
                        <p><h4>Block Operator</h4></p>
                        <p style="font-family: fantasy">Enter Operator Username to block</p>
                        <p><input type="text" onpaste="return false;" name="oname" id="user" style="height:25px;width:220px;"/></p>

                        <p ><input type="submit" value="Block" style="height:25px;width:100px;font-family: cursive" /> <input type="reset" value="Cancel" style="height:25px;width:100px;font-family: cursive" /></p>
                    </form>
                </center>
            </div>
