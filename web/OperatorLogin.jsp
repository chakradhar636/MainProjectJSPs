    ...
    <div id="templatemo_menu">
        <div class="indentmenu">
            <ul>
                ...
                <li><a href="OperatorLogin.jsp" rel="tab4" class="selected">Operator Login</a></li>
    ...
    <div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left">
                <center>
                    <form action ="ValidateOperator.jsp" method="post" onsubmit="return Checked();" style="margin-left: 150px;float: left">
                        <p><h4>Enter Operator Credentials</h4></p>
